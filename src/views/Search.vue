    ...
    <el-row :gutter="16">
      ...
      <el-col :span="19">
                ...
                <el-row :gutter="5">
                  ...
                  <el-col :span="6">
                    <el-form-item label="检索类型：" required>
                      <el-select
                        size="small"
                        v-model="this.advancedSearch.retrievalWordType"
                        placeholder="请选择检索类型"
                      >
                        <el-option
                  ...
                  <el-col :span="6">
                    ...
                    <el-form-item label="文献类型：">
                      <el-select
                        size="small"
                        v-model="this.advancedSearch.literatureType"
                        placeholder="请选择文献类型"
                      >
                        <el-option
        ...
        >
          ...
          <el-table-column align="center" width="110" label="操 作">
...
function similarSearch(that) {
  ...
  axios
    .get(
      "http://localhost:8900/es/similar-query?originKeywords=" +
        that.detailData.keyword +
        "&page=" +
        that.similarPage +
        "&size=" +
        that.similarSize
