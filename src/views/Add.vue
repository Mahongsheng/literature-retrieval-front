<template>
  ...
  <el-row>
    ...
    <el-col :span="12">
      <el-form label-width="120px" class="add-form" ref="form" :model="form" :rules="rules">
        <el-row>
          <el-col :span="12">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="关键字" prop="keyword">
              <el-input v-model="form.keyword" placeholder="不同关键字用';'分开"></el-input>
            </el-form-item>
          </el-col>
        </el-row>

          <el-form-item label="摘要" prop="literatureAbstract">
            <el-input v-model="form.literatureAbstract" :autosize="{minRows:2,maxRows:4}" type="textarea"></el-input>
          </el-form-item>
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="发表时间" prop="publicationTime">
              <el-date-picker v-model="form.publicationTime" type="date"></el-date-picker>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="8">
            <el-form-item label="文献类型" prop="literatureType">
              <el-select v-model="form.literatureType">
      ...
      this.$refs[form].validate((valid) => {
        if (valid) {
          var json = {
            ...
            literatureAbstract: form.literatureAbstract,
            origin: form.origin,
            publicationTime: form.publicationTime,
            literatureType: form.literatureType
          }
